...
- Dependency audit: production dependencies report 0 vulnerabilities after the `js-yaml` 4.3.1 lockfile update. The development audit still reports 16 findings, including Electron/electron-builder issues whose fixes require separately tested major-version upgrades.
